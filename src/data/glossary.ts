...
const terms: Omit<GlossaryTerm, "slug">[] = [
  { term: "Bacteriostatic Water", definition: "Sterile water with a preservative used to reconstitute lyophilized peptides. Each product specifies the correct volume." },
  ...
  { term: "GHK-Cu", definition: "Copper peptide complex; tightens loose skin, reduces fine lines, fights hair loss, wound healing." },
  ...
  { term: "Reconstitution", definition: "Mixing Bacteriostatic Water with lyophilized (powder) peptide to prepare for injection." },
