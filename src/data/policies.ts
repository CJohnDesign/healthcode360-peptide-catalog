/**
 * HC360-approved policies for HealthCode360.
 */
...
export const policySections: PolicySection[] = [
  {
    ...
    content: [
      "You understand and acknowledge that certain products made available through HealthCode360 may include peptides, compounded preparations, nutraceuticals, or other advanced therapeutics that may be off-label and/or not approved by the U.S. Food & Drug Administration (FDA) for certain uses or indications. Some products may be labeled by the manufacturer as \"For Research Use Only\" or \"Not for Human Use.\"",
  ...
  },
  {
    ...
    content: [
      ...
      "If you receive items that are missing, incorrect, or damaged, you must contact us within 48 hours of delivery at member@healthcode360.com so we may evaluate the issue and provide a resolution in our discretion (which may include replacement or store credit where permitted).",
    ],
  },
  {
    id: "shipping",
    ...
    content: [
      ...
      "International Orders: International orders are placed at the buyer's risk. HealthCode360 assumes no liability for issues outside our control, including customs seizures, shipping delays, or lost packages. International orders are final sale and are not eligible for returns, refunds, exchanges, or reshipment.",
    ],
  },
  {
    id: "confirmation",
